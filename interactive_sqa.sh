...
CONFIG_NAME=modular_audio_t5_sqa_config
...
HYDRA_FULL_ERROR=1 TORCH_CUDNN_V8_API_ENABLED=1 python ${SCRIPT_PATH} \
    ...
    ++exp_manager.exp_dir=/results/sqa_interactive \
    ...
    model.salm_model_path=$PRETRAINED_SQA_MODEL \
...
++model.data.validation_ds.output_dir=/results/sqa_interactive \
