...
def main():
    ...
    parser.add_argument(
        '--source_wav_dir',
        type=str,
        default="/workspace/data/s2s/es/source_wav/",
    )
    parser.add_argument(
        '--out_shar_dir',
        type=str,
        default="/workspace/data/s2s_shars/es/",
    )
    parser.add_argument(
        '--codec_dir',
        type=str,
    ...
    parser.add_argument(
        '--codec_np_dir',
        type=str,
        default="/workspace/data/s2s_codec/es/codecs/numpy/",
    )
    parser.add_argument(
        '--source_lang',
        type=str,
    ...
    create_shar_from_manifest(
        ...
        wav_dirs=[
            f"{args.source_wav_dir}/audio_{i}" for i in range(512)
        ],
        out_shar_dir=args.out_shar_dir,
        codec_dir=args.codec_dir,
        codec_np_dir=args.codec_np_dir,
